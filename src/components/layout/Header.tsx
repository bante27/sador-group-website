...
export function Header() {
    ...
    return (
        ...
        >
            <div className="bg-slate-950 text-slate-300 text-xs py-4 px-4 sm:px-6 lg:px-8 xl:px-12 border-b border-slate-800">
                <div className="max-w-[1600px] mx-auto flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <span className="hidden sm:inline text-slate-400">Enterprise Digital Ecosystem</span>
                        <span className="hidden sm:inline text-slate-600">|</span>
                        <a href="mailto:mitikubantalem@gmail.com" className="hover:text-amber-400 transition-colors flex items-center gap-1.5">
                            <svg className="w-3.5 h-3.5 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                            </svg>
                            mitikubantalem@gmail.com
                        </a>
                    </div>
                    <div className="flex items-center gap-3">
                        <span className="text-slate-400 mr-1 hidden md:inline">Follow Us:</span>
                        <a
                            href="https://www.linkedin.com/in/bantalem-mitiku-096119392"
                            target="_blank"
